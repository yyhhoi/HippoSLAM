...
def main(run_dir):
    ...
    # # 1: Simulation:
    # # This step simulates a random agent to sample camera images in the environment.
    # # Check if you already have images at data/OfflineAnalysis/OfflineStateMapLearner/imgs.
    # # If there are already image samples in this directory, you may not need to run this step.
    # ====================== Uncomment below ===========================
