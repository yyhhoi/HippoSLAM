...
def AWAC_offline_imitation():
    # =============================================================================
    # ============================= Modifiable ====================================
    # =============================================================================
    # Project identifiers
    experiment = 'ImitationLearningDemo'
    run = 'OfflineImitation'
    load_buffer_dir = join('data', experiment, 'NaiveAvoidance')
    ...
    load_buffer_pth = join(load_buffer_dir, 'ReplayBuffer.pickle')
    save_ckpt_pth = join(save_dir, 'CKPT.pt')
    loss_records_pth = join(save_dir, 'LOSS.png')
    ...
    data = read_pickle(load_buffer_pth)
