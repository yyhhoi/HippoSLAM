...
def ImageSampling():
    ...
    save_hipposlam_pth = join(project_dir, 'hipposlam_lib.pickle')
...
def fine_tune_trained_model():
    ...
    load_hipposlam_pth = join('data', 'StateMapLearner', 'hipposlam_lib.pickle')
...
def naive_avoidance():
    ...
    load_hipposlam_pth = join('data', 'StateMapLearner', 'hipposlam_lib.pickle')
    save_hipposlam_pth = join('data', 'StateMapLearner', 'hipposlam_lib.pickle')
